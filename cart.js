// ============================================================
//  cart.js — Logique panier partagée entre toutes les pages
...
const Cart = {
  ...
  // ── Lecture / écriture ─────────────────────────────────────
  getItems() {
    try { return JSON.parse(localStorage.getItem('nymphe_cart') || '[]'); }
    catch { return []; }
  },
  save(items) {
  ...
  // ── Totaux ────────────────────────────────────────────────
  totalQty()   { return Cart.getItems().reduce((s, i) => s + i.qty, 0); },
  totalPrice() { return Cart.getItems().reduce((s, i) => s + i.prix * i.qty, 0); },
