...
const ADMIN_ORIGIN = import.meta.env.VITE_ADMIN_URL ?? 'https://admin.nympheillustration.com'
  ...
  if (!product) {
    return (
      <div className="flex items-center justify-center h-screen bg-linen">
        <p className="text-brown-light text-sm animate-pulse">Chargement de la preview…</p>
      </div>
    )
  }
        ...
        <div className="product-page">
          ...
          <div className="product-gallery">
            <div className="product-gallery-main">
              {imageUrl ? (
                <img src={imageUrl} alt={product.titre} className="product-img" />
              ) : (
                <div
                  style={{
                    width: '100%',
          ...
          <div className="product-detail">
            ...
            <div className="format-options">
              {['A5 — 14×21 cm', 'A4 — 21×29 cm', 'A3 — 30×42 cm'].map((f, i) => (
                <button
                  key={f}
            ...
            <div className="product-cta">
              <button className="btn-primary" style={{ flex: 1, opacity: 0.6, cursor: 'default' }}>
                Ajouter au panier
              </button>
              <button className="btn-wishlist" aria-label="Favoris" style={{ opacity: 0.6 }}>
                <Heart size={20} />
              </button>
            </div>
